...
void CGraphicsApp::__initShader()
{
	...
	m_pShader->addShader("../ShaderSources/LN023/SceneVertShader.glsl", VERTEX_SHADER);
	m_pShader->addShader("../ShaderSources/LN023/SceneFragShader.glsl", FRAGMENT_SHADER);
	m_pShader->createShaderProgram();

	m_pGenerateSceneGBufferShader = std::make_shared<CShader>();
	m_pGenerateSceneGBufferShader->addShader("../ShaderSources/LN023/GenerateSceneGBufferVert.glsl", VERTEX_SHADER);
	m_pGenerateSceneGBufferShader->addShader("../ShaderSources/LN023/GenerateSceneGBufferFrag.glsl", FRAGMENT_SHADER);
